...
function validate( $link, $email = '', $pwd = '')
{
  ...
  if ( empty( $errors ) ) 
  {
    #$q = "SELECT user_id, first_name, last_name FROM usertable WHERE email='$e' AND pass=SHA2('$p',256)" ;
    $q = "SELECT user_id, first_name, last_name FROM usertable WHERE email='$e' AND pass='$p'" ;  
